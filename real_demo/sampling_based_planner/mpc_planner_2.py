...
from sampling_based_planner.quat_math import rotation_quaternion, quaternion_multiply, quaternion_distance
...
class run_cem_planner:
    def __init__(self, model, data, num_dof=12, num_batch=500, num_steps=20, 
                 ...
                 ik_pos_thresh=None, ik_rot_thresh=None, 
                 collision_free_ik_dt=0.5, inference=False, rnn=None,
                 max_joint_pos=None, max_joint_vel=None, 
