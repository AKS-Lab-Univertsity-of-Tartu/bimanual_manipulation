...
class cem_planner():
	...
	def compute_projection_single_dof(self, 
		...
		def lax_custom_projection(carry, idx):
			...
			xi_projected_prev, lamda_prev, s_prev = xi_projected, lamda, s
			
			xi_projected, s, res_projection, lamda = self.compute_feasible_control_single_dof(lamda, 
																		s, b_eq_term, xi_projected, 
																		init_pos_single_dof)
			...
			fixed_point_residual = (
				...
				jnp.linalg.norm(xi_projected_prev - xi_projected, axis=1)
